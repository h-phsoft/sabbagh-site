    ...
    var Paging = {
      "setOptions": function (opts) {
        ...
        Paging.opts = $.extend(Paging.opts || {
          "direction": "ltr", // number of elements overlap
          ...
          "onFormat": function (type) {	// callback for every format element
            if (Paging.opts["direction"] == 'ltr') {
              switch (type) {
                ...
                case 'first':
                  if (this.active) {
                    return '<li class="first"><a href="#" title="First"><i class="glyphicon glyphicon-step-backward"></i></a></li>';
                  }
                  return '<li class="first disabled"><a href="#" title="First"><i class="glyphicon glyphicon-step-backward"></i></a></li>';
                case 'prev':
                  if (this.active) {
                    return '<li class="prev"><a href="#" title="Previous"><i class="glyphicon glyphicon-chevron-left"></i></a></li>';
                  }
                  return '<li class="prev disabled"><a href="#" title="Previous"><i class="glyphicon glyphicon-chevron-left"></i></a></li>';
                case 'next':
                  if (this.active) {
                    return '<li class="next"><a href="#" title="Next"><i class="glyphicon glyphicon-chevron-right"></i></a></li>';
                  }
                  return '<li class="next disabled"><a href="#" title="Next"><i class="glyphicon glyphicon-chevron-right"></i></a></li>';
                case 'last':
                  if (this.active) {
                    return '<li class="last"><a href="#" title="Last"><i class="glyphicon glyphicon-step-forward"></i></a></li>';
                  }
                  return '<li class="last disabled"><a href="#" title="Last"><i class="glyphicon glyphicon-step-forward"></i></a></li>';
                case "leap":
                  if (this.active) {
                    return "";
                  }
              ...
              switch (type) {
                ...
                case 'first':
                  if (this.active) {
                    return '<li class="first"><a href="#" title="First"><i class="glyphicon glyphicon-step-forward"></i></a></li>';
                  }
                  return '<li class="first disabled"><a href="#" title="First"><i class="glyphicon glyphicon-step-forward"></i></a></li>';
                case 'prev':
                  if (this.active) {
                    return '<li class="prev"><a href="#" title="Previous"><i class="glyphicon glyphicon-chevron-left"></i></a></li>';
                  }
                ...
                case 'last':
                  if (this.active) {
                    return '<li class="last"><a href="#" title="Last"><i class="glyphicon glyphicon-step-backward"></i></a></li>';
                  }
                  return '<li class="last disabled"><a href="#" title="Last"><i class="glyphicon glyphicon-step-backward"></i></a></li>';
                case "leap":
                  if (this.active) {
                    return "";
                  }
