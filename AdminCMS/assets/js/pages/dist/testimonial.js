...
jQuery(document).ready(function () {
  ...
  mettaData.URLS = {
    "Save": {
      "URL": PhSettings.serviceURL + "/Testimonial",
      "Method": "POST"
    },
    "Get": {
      "URL": PhSettings.serviceURL + "/Testimonial",
  ...
  mettaData.ImagePath = PhSettings.mediaPath + 'Testimonial/';
...
function doEdit(nIdx) {
  ...
  $('#fldCountry').val(item.vCountry);
  $('#fldTown').val(item.vTown);
            ...
            <div class="row pt-3 px-3">
              <div class="col-12">
                <div class="row">
                  ...
                  <div class="col-12">
                    <span>${item.vCountry}</span>
                  </div>
                  <div class="col-12">
                    <span>${item.vTown}</span>
                  </div>
                  <div class="col-12">
