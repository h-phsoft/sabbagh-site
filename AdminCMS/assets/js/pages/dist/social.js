...
jQuery(document).ready(function () {
  ...
  mettaData.URLS = {
    "Save": {
      "URL": PhSettings.serviceURL + "/Social",
      "Method": "POST"
    },
    "Get": {
      "URL": PhSettings.serviceURL + "/Social",
      ...
      `<div class="col-sm-3 p-2 mx-auto">
        <div id="item-${item.nId}" class="card card-product h-100">
          <div class="card-body p-0">
            <div class="row">
              <div class="col-12 p-2 edit-item" data-rid="${i}">
...
function renderTable() {
  ...
  for (var i = 0; i < resultData.length; i++) {
    let item = resultData[i];
    vHtml += `<article class="itemlist col-12 p-2">
