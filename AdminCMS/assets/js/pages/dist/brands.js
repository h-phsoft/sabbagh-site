...
jQuery(document).ready(function () {
  ...
  mettaData.URLS = {
    "Save": {
      "URL": PhSettings.serviceURL + "/Brands",
      "Method": "POST"
    },
    "Get": {
      "URL": PhSettings.serviceURL + "/Brands",
  ...
  mettaData.ImagePath = PhSettings.mediaPath + 'Brands/';
...
function doEdit(nIdx) {
  ...
  $('#fldId').val(item.nId);
  $('#fldId').val(item.nId);
  $('#fldSupplierId').val(item.nSupplierId);
