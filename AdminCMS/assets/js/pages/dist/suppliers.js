...
jQuery(document).ready(function () {
  ...
  mettaData.URLS = {
    "Save": {
      "URL": PhSettings.serviceURL + "/Suppliers",
      "Method": "POST"
    },
    "Get": {
      "URL": PhSettings.serviceURL + "/Suppliers",
  ...
  mettaData.ImagePath = PhSettings.mediaPath + 'Suppliers/';
...
function getPage(vText, nStart, nEnd, nPage, nPerPage) {
  ...
  $.ajax({
    ...
    data: {
      ...
      'nId': $('#fldId').val(),
      'nGroupId': $('#fldGroupId').val(),
      'nCountryId': $('#fldCountryId').val(),
    },
...
function doNew() {
  ...
  $('#fldId').val(0);
  $('#fldId').val(0);
  $('#fldGroupId').val($('#fldGroupId :first').val());
  $('#fldCountryId').val($('#fldCountryId :first').val());
  $('#fldName').val('');
  $('#fldPrice').val('');
  $('#fldParagraph').val('');
...
function doEdit(nIdx) {
  ...
  $('#fldId').val(item.nId);
  $('#fldId').val(item.nId);
  $('#fldGroupId').val(item.nGroupId);
  $('#fldCountryId').val(item.nCountryId);
  $('#fldName').val(item.vName);
  $('#fldPrice').val(item.vPrice);
  $('#fldParagraph').val(item.vParagraph);
          ...
          <div class="card-body p-0">
            ...
            <div class="row pt-3 px-3">
              <div class="col-12">
                <div class="row">
                  <div class="col-12">
                    <span>${item.vGroupName}</span>
                  </div>
                  <div class="col-12">
                    <span>${item.vCountryName}</span>
                  </div>
                  <div class="col-12">
