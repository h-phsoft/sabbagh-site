...
jQuery(document).ready(function () {
  ...
  mettaData.URLS = {
    "Save": {
      "URL": PhSettings.serviceURL + "/Blog",
      "Method": "POST"
    },
    "Get": {
      "URL": PhSettings.serviceURL + "/Blog",
  ...
  mettaData.ImagePath = PhSettings.mediaPath + 'Blog/';
...
function doEdit(nIdx) {
  ...
  $('#fldPostedBy').val(item.vPostedBy);
  $('#fldText').val(item.vText);
