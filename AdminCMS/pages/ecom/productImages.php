          ...
          <div class="row">
            <div class="col-sm-8 py-2">
              <div class="row pt-1">
                ...
                <label for="fldMnum" class="col-form-label col-sm-2 text-center text-sm-end"><?php echo getLabel('Mnum'); ?></label>
                <div class="col-sm-4">
                  <input id="fldMnum" class="form-control form-control-sm" type="text" value="" autocomplete="off" required="true" />
                </div>
              </div>
              <div class="row pt-1">
                <label for="fldBrandId" class="col-form-label col-sm-2 text-center text-sm-end"><?php echo getLabel('BrandId'); ?></label>
                <div class="col-sm-4">
                ...
                <label for="fldCatId" class="col-form-label col-sm-2 text-center text-sm-end"><?php echo getLabel('CatId'); ?></label>
                <div class="col-sm-4">
              ...
              <div class="row pt-1">
                <label for="fldStatusId" class="col-form-label col-sm-2 text-center text-sm-end"><?php echo getLabel('StatusId'); ?></label>
                <div class="col-sm-4">
                ...
                <label for="fldTagId" class="col-form-label col-sm-2 text-center text-sm-end"><?php echo getLabel('TagId'); ?></label>
                <div class="col-sm-4">
              ...
              <div class="row pt-1">
                ...
                <label for="fldCprice" class="col-form-label col-sm-2 text-center text-sm-end"><?php echo getLabel('Cprice'); ?></label>
                <div class="col-sm-4">
                  <input id="fldCprice" class="form-control form-control-sm" type="text" value="" autocomplete="off" required="true" />
                </div>
              </div>
              <div class="row pt-1">
                <label for="fldDesc1" class="col-form-label col-sm-2 text-center text-sm-end"><?php echo getLabel('Desc1'); ?></label>
                <div class="col-sm-10">
                  <input id="fldDesc1" class="form-control form-control-sm" type="text" value="" autocomplete="off" />
                </div>
              </div>
              <div class="row pt-1">
                <label for="fldDesc2" class="col-form-label col-sm-2 text-center text-sm-end"><?php echo getLabel('Desc2'); ?></label>
                <div class="col-sm-10">
