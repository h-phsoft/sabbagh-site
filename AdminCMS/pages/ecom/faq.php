          ...
          <div class="col-sm-12">
            <form id="ph_Form">
              <div class="row pt-1">
                ...
                <label for="fldOrd" class="col-form-label col-sm-2 text-center"><?php echo getLabel('Order'); ?></label>
                <div class="col-sm-2">
                  <input id="fldOrd" class="form-control form-control-sm" type="text" value="" autocomplete="off" required="true" />
                </div>
              </div>
              <div class="row pt-1">
                <label for="fldQText" class="col-form-label col-sm-2 text-center"><?php echo getLabel('Question'); ?></label>
                <div class="col-sm-10">
                  <input id="fldQText" class="form-control form-control-sm" type="text" value="" autocomplete="off" required="true" />
                </div>
              </div>
              <div class="row pt-1">
                <label for="fldAText" class="col-form-label col-sm-2 text-center"><?php echo getLabel('Answer'); ?></label>
                <div class="col-sm-10">
                  <textarea id="fldAText" class="form-control form-control-sm" rows="4"></textarea>
                </div>
              </div>
            </form>
          </div>
