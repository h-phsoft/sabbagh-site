            ...
            <form id="ph_Form">
              <div class="row pt-1">
                <div class="col-sm-8 py-2">
                  ...
                  <div class="row pt-1">
                    <label for="fldStatusId" class="col-form-label col-sm-2 text-center"><?php echo getLabel('Status'); ?></label>
                    <div class="col-sm-4">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="w-100 p-0 text-center">
                        <input id="fldFile" type="file" class="fileField d-none" accept="image/*" value="" data-previewer="fldImagePreview" data-relfld="fldAttach" data-filename="fldFileName"  data-relname="fldFName" data-relext="fldFExt" data-folder="itembanner">
