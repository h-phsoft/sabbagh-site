          ...
          <div class="row pt-1">
            <div class="col-sm-12 py-2">
              <div class="row pt-1">
                ...
                <label for="fldText1" class="col-form-label col-sm-2 text-center"><?php echo getLabel('Name1'); ?></label>
                <div class="col-sm-10">
                  <input id="fldText1" class="form-control form-control-sm" type="text" value="" autocomplete="off" required="true" />
                </div>
              </div>
              <div class="row pt-1">
                <label for="fldText2" class="col-form-label col-sm-2 text-center"><?php echo getLabel('Name2'); ?></label>
                <div class="col-sm-10">
                  <input id="fldText2" class="form-control form-control-sm" type="text" value="" autocomplete="off" required="true" />
                </div>
              </div>
            </div>
          </div>
