          ...
          <div class="row pt-1">
            <div class="col-sm-8 py-2">
              <div class="row pt-1">
                ...
                <label for="fldText1" class="col-form-label col-sm-2 text-center"><?php echo getLabel('Text1'); ?></label>
                <div class="col-sm-10">
                  <textarea id="fldText1" class="form-control form-control-sm" type="text" value="" dir="ltr" autocomplete="off" required="true" rows="12">
                  </textarea>
                </div>
              </div>
              <div class="row pt-1">
                <label for="fldText2" class="col-form-label col-sm-2 text-center"><?php echo getLabel('Text2'); ?></label>
                <div class="col-sm-10">
                  <textarea id="fldText2" class="form-control form-control-sm" type="text" value="" dir="ltr" autocomplete="off" required="true" rows="12">
                  </textarea>
                </div>
              </div>
            </div>
