      ...
      <div class="modal-body" style="max-height: 70vh; overflow-y: auto;">
        <form id="ph_Form">
          <div class="row pt-1">
            ...
            <label for="fldName" class="col-form-label col-sm-2 text-center text-sm-end"><?php echo getLabel('Name'); ?></label>
            <div class="col-sm-10">
              <input id="fldName" class="form-control form-control-sm" type="text" value="" autocomplete="off" required="true" />
            </div>
          </div>
          <div class="row pt-1">
            <label for="fldPhone" class="col-form-label col-sm-2 text-center text-sm-end"><?php echo getLabel('Phone'); ?></label>
            <div class="col-sm-5">
              <input id="fldPhone" class="form-control form-control-sm" type="text" value="" autocomplete="off" required="true" />
            </div>
          </div>
          <div class="row pt-1">
            <label for="fldAddress" class="col-form-label col-sm-2 text-center text-sm-end"><?php echo getLabel('Address'); ?></label>
            <div class="col-sm-10">
