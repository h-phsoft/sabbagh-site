              ...
              <div class="card card-custom">
                <div class="card-body">
                  ...
                  <div class="row pt-1">
                    ...
                    <label for="fldWork" class="col-form-label col-sm-2 text-end"><?php echo getLabel('lbl.cms.Work'); ?></label>
                    <div class="col-12 col-sm-4">
                      <input id="fldWork" class="form-control form-control-sm" type="text" value="" autocomplete="off" required="true" />
                    </div>
                  </div>
                  <div class="row pt-1">
                    <label for="fldFacebook" class="col-form-label col-sm-2 text-end"><?php echo getLabel('lbl.cms.Facebook'); ?></label>
                    <div class="col-12 col-sm-4">
                      <input id="fldFacebook" class="form-control form-control-sm" type="text" value="" autocomplete="off" required="true" />
                    </div>
                    <label for="fldTwitter" class="col-form-label col-sm-2 text-end"><?php echo getLabel('lbl.cms.Twitter'); ?></label>
                    <div class="col-12 col-sm-4">
                      <input id="fldTwitter" class="form-control form-control-sm" type="text" value="" autocomplete="off" required="true" />
                    </div>
                  </div>
                  <div class="row pt-1">
                    <label for="fldInstagram" class="col-form-label col-sm-2 text-end"><?php echo getLabel('lbl.cms.Instagram'); ?></label>
                    <div class="col-12 col-sm-4">
                      <input id="fldInstagram" class="form-control form-control-sm" type="text" value="" autocomplete="off" required="true" />
                    </div>
                    <label for="fldLinkedin" class="col-form-label col-sm-2 text-end"><?php echo getLabel('lbl.cms.Linkedin'); ?></label>
                    <div class="col-12 col-sm-4">
                      <input id="fldLinkedin" class="form-control form-control-sm" type="text" value="" autocomplete="off" required="true" />
                    </div>
                  </div>
                </div>
              </div>
