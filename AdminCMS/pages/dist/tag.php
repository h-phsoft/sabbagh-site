            ...
            <div class="row pt-2">
              ...
              if ($perms->Query) {
                ...
                <div class="col-sm-1 ps-0 pe-0">
                  <select id="ph-search-list-Color" class="form-control">
                    <option value="-1"><?php echo getLabel('lbl.cms.Color'); ?></option>
                    <?php
              ...
              <div class="card card-custom">
                <div class="card-body">
                  ...
                  <div class="row pt-1">
                    ...
                    <label for="fldColorId" class="col-form-label col-sm-2 text-end"><?php echo getLabel('lbl.cms.ColorId'); ?></label>
                    <div class="col-12 col-sm-4">
                      <select id="fldColorId" class="form-control form-control-sm form-select">
                        <?php
                        foreach ($aColors as $element) {
                          ?>
