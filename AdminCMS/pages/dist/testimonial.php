              ...
              <div class="card card-custom">
                <div class="card-body">
                  ...
                  <div class="row pt-1">
                    ...
                    <label for="fldCountry" class="col-form-label col-sm-2 text-end"><?php echo getLabel('lbl.cms.Country'); ?></label>
                    <div class="col-12 col-sm-4">
                      <input id="fldCountry" class="form-control form-control-sm" type="text" value="" autocomplete="off" required="true" />
                    </div>
                  </div>
                  <div class="row pt-1">
                    <label for="fldTown" class="col-form-label col-sm-2 text-end"><?php echo getLabel('lbl.cms.Town'); ?></label>
                    <div class="col-12 col-sm-4">
                      <input id="fldTown" class="form-control form-control-sm" type="text" value="" autocomplete="off" required="true" />
                    </div>
                  </div>
                  <div class="row pt-1">
                    <label for="fldParagraph" class="col-form-label col-sm-2 text-end"><?php echo getLabel('lbl.cms.Paragraph'); ?></label>
                    <div class="col-12 col-sm-10">
                      <textarea id="fldParagraph" class="form-control form-control-sm" autocomplete="off" required="true" row="10">
                      </textarea>
                    </div>
                  </div>
                </div>
