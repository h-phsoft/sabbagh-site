            ...
            <div class="card-body">
              ...
              <div class="row pt-1">
                ...
                <div class="col-12 col-sm-4">
                  <input id="fldName" class="form-control form-control-sm" type="text" value="" autocomplete="off" required="true" disabled="true"/>
                </div>
                <label for="fldVal" class="col-form-label col-sm-2 text-end"><?php echo getLabel('lbl.cms.Val'); ?></label>
                <div class="col-12 col-sm-4">
                  <input id="fldVal" class="form-control form-control-sm" type="text" value="" autocomplete="off" required="true" />
                </div>
              </div>
            </div>
          </div>
