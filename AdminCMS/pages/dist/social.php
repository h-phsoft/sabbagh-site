        ...
        <div class="col-sm-12">
          <div class="card card-custom">
            <div class="card-body">
              ...
              <div class="row pt-1">
                <label for="fldLink" class="col-form-label col-sm-2 text-end"><?php echo getLabel('lbl.cms.Link'); ?></label>
                <div class="col-12 col-sm-4">
                  <input id="fldLink" class="form-control form-control-sm" type="text" value="" autocomplete="off" required="true" />
                </div>
              </div>
            </div>
          </div>
