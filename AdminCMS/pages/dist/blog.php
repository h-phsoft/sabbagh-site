              ...
              <div class="card card-custom">
                <div class="card-body">
                  ...
                  <div class="row pt-1">
                    ...
                    <label for="fldPostedBy" class="col-form-label col-sm-2 text-end"><?php echo getLabel('lbl.cms.PostedBy'); ?></label>
                    <div class="col-12 col-sm-4">
                      <input id="fldPostedBy" class="form-control form-control-sm" type="text" value="" autocomplete="off" required="true" />
                    </div>
                  </div>
                  <div class="row pt-1">
                    <label for="fldText" class="col-form-label col-sm-2 text-end"><?php echo getLabel('lbl.cms.Text'); ?></label>
