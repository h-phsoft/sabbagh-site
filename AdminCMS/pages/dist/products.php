...
$aCategories = cDistCategories::getArray();
?>
            ...
            <div class="row pt-2">
              ...
              if ($perms->Query) {
                ...
                <div class="col-sm-2 ps-0 pe-0">
                  <select id="ph-search-list-Category" class="form-control">
                    <option value="-1"><?php echo getLabel('lbl.cms.Category'); ?></option>
                    <?php
                    foreach ($aCategories as $element) {
                      ?>
              ...
              <div class="card card-custom">
                <div class="card-body">
                  ...
                  <div class="row pt-1">
                    ...
                    <label for="fldCategoryId" class="col-form-label col-sm-2 text-end"><?php echo getLabel('lbl.cms.CategoryId'); ?></label>
                    <div class="col-12 col-sm-4">
                      <select id="fldCategoryId" class="form-control form-control-sm form-select">
                        <?php
                        foreach ($aCategories as $element) {
                          ?>
                    ...
                    <label for="fldPrice" class="col-form-label col-sm-2 text-end"><?php echo getLabel('lbl.cms.Price'); ?></label>
                    <div class="col-12 col-sm-4">
