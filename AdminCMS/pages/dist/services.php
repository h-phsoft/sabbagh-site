          ...
          <div class="card card-custom">
            <div class="card-body">
              ...
              <div class="row pt-1">
                ...
                <label for="fldOrd" class="col-form-label col-sm-2 text-end"><?php echo getLabel('lbl.cms.Ord'); ?></label>
                <div class="col-12 col-sm-4">
                  <input id="fldOrd" class="form-control form-control-sm" type="text" value="" autocomplete="off" required="true" />
                </div>
                <label for="fldTitle" class="col-form-label col-sm-2 text-end"><?php echo getLabel('lbl.cms.Title'); ?></label>
                <div class="col-12 col-sm-4">
              ...
              <div class="row pt-1">
                ...
                <div class="col-12 col-sm-4">
                  <input id="fldParagraph" class="form-control form-control-sm" type="text" value="" autocomplete="off" required="true" />
                </div>
                <label for="fldIcon" class="col-form-label col-sm-2 text-end"><?php echo getLabel('lbl.cms.Icon'); ?></label>
                <div class="col-12 col-sm-4">
                  <input id="fldIcon" class="form-control form-control-sm" type="text" value="" autocomplete="off" required="true" />
                </div>
              </div>
            </div>
          </div>
