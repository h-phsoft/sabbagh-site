...
$aCountrys = cDistCountry::getArray();
$aGroups = cDistGroups::getArray();
?>
            ...
            <div class="row pt-2">
              ...
              if ($perms->Query) {
                ...
                <div class="col-sm-1 ps-0 pe-0">
                  <select id="ph-search-list-Country" class="form-control">
                    <option value="-1"><?php echo getLabel('lbl.cms.Country'); ?></option>
                    <?php
                    foreach ($aCountrys as $element) {
                      ?>
                      <option value="<?php echo $element->Id; ?>"><?php echo ($oLang->Code === 'en') ? $element->Name : $element->Name; ?></option>
                      <?php
                    }
                    ?>
                  </select>
                ...
                <div class="col-sm-1 ps-0 pe-0">
                  <select id="ph-search-list-Group" class="form-control">
                    <option value="-1"><?php echo getLabel('lbl.cms.Group'); ?></option>
                    <?php
                    foreach ($aGroups as $element) {
                      ?>
                      <option value="<?php echo $element->Id; ?>"><?php echo ($oLang->Code === 'en') ? $element->Name : $element->Name; ?></option>
                      <?php
                    }
              ...
              <div class="card card-custom">
                <div class="card-body">
                  ...
                  <div class="row pt-1">
                    ...
                    <label for="fldGroupId" class="col-form-label col-sm-2 text-end"><?php echo getLabel('lbl.cms.GroupId'); ?></label>
                    <div class="col-12 col-sm-4">
                      <select id="fldGroupId" class="form-control form-control-sm form-select">
                        <?php
                        foreach ($aGroups as $element) {
                          ?>
                    ...
                    <label for="fldCountryId" class="col-form-label col-sm-2 text-end"><?php echo getLabel('lbl.cms.CountryId'); ?></label>
                    <div class="col-12 col-sm-4">
                      <select id="fldCountryId" class="form-control form-control-sm form-select">
                        <?php
                        foreach ($aCountrys as $element) {
                          ?>
                          <option value="<?php echo $element->Id; ?>"><?php echo $element->Name; ?></option>
                  ...
                  <div class="row pt-1">
                    <label for="fldParagraph" class="col-form-label col-sm-2 text-end"><?php echo getLabel('lbl.cms.Paragraph'); ?></label>
                    <div class="col-12 col-sm-10">
                      <textarea id="fldParagraph" class="form-control form-control-sm"  autocomplete="off" required="true" rows="25">
                      </textarea>
                    </div>
                  </div>
                </div>
