...
if (isset($oRest)) {
  ...
  $aList = cEcomCat::getArray($vWhere, '', $nPage, $nPageSize);
  $aData = array();
  $nIdx = 0;
  foreach ($aList as $element) {
    $aData[$nIdx] = array(
      ...
      'vKindName' => $element->oKind->Name,
      'vShopName' => $element->oShop->Name,
      'vMenuName' => $element->oMenu->Name,
    );
    $nIdx++;
  }
