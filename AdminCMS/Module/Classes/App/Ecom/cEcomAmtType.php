...
class cEcomAmtType {
  ...
  public static function getCount($vWhere = '') {
    $nCount = 0;
    $sSQL = 'SELECT count(*) nCnt FROM `ecom_amt_type`';
    if ($vWhere != '') {
      $sSQL .= ' WHERE (' . $vWhere . ') ';
    }
    $res = ph_Execute($sSQL);
  ...
  public function save($nUId) {
    ...
    if ($this->Id == 0 || $this->Id == -999) {
      $vSQL = 'INSERT INTO `ecom_amt_type` ('
        . '  `name`, `rem`, `ins_user`'
        . ') VALUES ('
        . '  "' . $this->Name . '"'
        . ', "' . $this->Rem . '"'
  ...
  public function delete() {
    $vSQL = 'DELETE FROM `ecom_amt_type` WHERE `id`="' . $this->Id . '"';
    $res = ph_Execute($vSQL);
    if ($res || $res === 0) {
