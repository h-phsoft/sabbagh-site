...
class cEcomService {
  ...
  public static function getSelectStatement($vWhere = '', $vOrder = '', $vLimit = '') {
    $sSQL = 'SELECT `id`, `Name1`, `Name2`, `type_id`, `amtperc`'
      . ' FROM `ecom_service`';
    if ($vWhere != '') {
      $sSQL .= ' WHERE (' . $vWhere . ') ';
    }
  ...
  public static function getCount($vWhere = '') {
    $nCount = 0;
    $sSQL = 'SELECT count(*) nCnt FROM `ecom_service`';
    if ($vWhere != '') {
      $sSQL .= ' WHERE (' . $vWhere . ') ';
    }
    $res = ph_Execute($sSQL);
  ...
  public function save() {
    ...
    if ($this->Id == 0 || $this->Id == -999) {
      $vSQL = 'INSERT INTO `ecom_service` ('
        . '  `Name1`, `Name2`, `type_id`, `amtperc`'
        . ') VALUES ('
        . '  "' . $this->Name1 . '"'
        . ', "' . $this->Name2 . '"'
        . ', "' . $this->TypeId . '"'
  ...
  public function delete() {
    $vSQL = 'DELETE FROM `ecom_service` WHERE `id`="' . $this->Id . '"';
    $res = ph_Execute($vSQL);
    if ($res || $res === 0) {
